...
# directory for spp peak calling
spp_dir="/projects/li-lab/agarwa/CUBE/DeepTact/code/spp"
...
input_control="/projects/li-lab/agarwa/CUBE/DeepTact/dataset/Mouse_data/chipseq/ch12.dupl.merged.srt.bam"
